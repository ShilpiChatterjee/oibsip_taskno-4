        ...
        <Box w={{sm:"90vw", lg:"30vw"}} border="1px solid #ccc" padding="20px" margin="auto" borderRadius="10px" backgroundColor="white">
            ...
            <Flex direction="column" gap="20px" w="100%">
                <FormControl isRequired>
                    ...
                    <Input isRequired placeholder='Name' name="name" onChange={(e)=>handleChange(e.target)} />
                </FormControl>
                <FormControl isRequired>
                    <FormLabel>Email</FormLabel>
                    <Input isRequired  placeholder='Email'  name="email" onChange={(e)=>handleChange(e.target)} />
                </FormControl>
                <FormControl isRequired>
